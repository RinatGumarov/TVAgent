/**
 * TVAgent — the semantic tool layer the LLM sees.
 *
 * The model never learns anything about TradingView internals: it gets these
 * ~19 tools, and each maps 1:1 onto a driver method. Permission levels follow
 * the plan's §15 model.
 *
 *   0 — read only            → always auto
